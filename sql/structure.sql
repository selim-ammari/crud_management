...
-- This file contains CREATE TABLE statements and sample data
...
(1, 29.99, 'completed', datetime('now', '-2 days')),
(2, 29.99, 'completed', datetime('now', '-1 day')),
(3, 29.99, 'completed', datetime('now', '-3 days')),
(1, 79.99, 'completed', datetime('now', '-5 days')),
(4, 29.99, 'completed', datetime('now', '-6 days'));

-- Older orders (more than 7 days ago)
INSERT INTO orders (user_id, total_amount, status, created_at) VALUES
(2, 49.99, 'completed', datetime('now', '-10 days')),
(3, 19.99, 'completed', datetime('now', '-15 days')),
(5, 39.99, 'completed', datetime('now', '-20 days')),
(1, 99.98, 'completed', datetime('now', '-25 days')),
(4, 29.99, 'completed', datetime('now', '-30 days'));
